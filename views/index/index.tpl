<div class="col-lg-6 col-md-8 mx-auto">
    ...
    <p class="lead text-muted">Una propuesta de desarrollo de software simple, escalable, basado en buenas prácticas de programación y el inconfundible patrón de arquitectura MVC (Modelo-vista-Controlador).</p>
    <p>
